...
export function DashboardClient({ data }: { data: DashboardData }) {
    const { leadsCaptured, leadsTrend, needsAttention, linkClicks, chartData, pipeline } = data;

    const pipelineStages = [
        { label: "New Leads", count: pipeline.newLeads, color: "bg-blue-500", context: "Untouched", href: "/customers?status=new" },
        { label: "In Conversation", count: pipeline.inConversation, color: "bg-yellow-500", context: "Ongoing", href: "/inbox" },
        { label: "Links Sent", count: pipeline.linksSent, color: "bg-purple-500", context: "Click tracked", href: "/customers?tag=link_sent" },
        { label: "Booked", count: pipeline.booked, color: "bg-green-500", context: "Returning customers", href: "/customers?tag=booked" },
    ];
                ...
                <Card className="relative overflow-hidden">
                    ...
                    <CardContent>
                        ...
                        <div className="flex items-center gap-1 mt-2 text-sm text-green-600">
                            ...
                            <span>{leadsTrend >= 0 ? '+' : ''}{leadsTrend} from yesterday</span>
                        </div>
                    </CardContent>
                </Card>
